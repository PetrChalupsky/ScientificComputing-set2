...
from scientificcomputing_set2.gray_scott import gray_scott, gray_scott_noise, all_concentrations_noise
import numpy as np
...
grid_u1_noise, grid_v1_noise, c_u1_noise, c_v1_noise = gray_scott_noise(width, dx, dt, t, Du, Dv, f1, k1, bc, seed=0)
all_concentrations_u1, all_concentrations_v1 = all_concentrations_noise(width, dx, dt, t, Du, Dv, f1, k1, bc)

# Parameter values 2
f2, k2 = 0.022, 0.051
grid_u2, grid_v2, c_u2, c_v2 = gray_scott(width, dx, dt, t, Du, Dv, f2, k2, bc)
grid_u2_noise, grid_v2_noise, c_u2_noise, c_v2_noise = gray_scott_noise(width, dx, dt, t, Du, Dv, f2, k2, bc, seed=0)
all_concentrations_u2, all_concentrations_v2 = all_concentrations_noise(width, dx, dt, t, Du, Dv, f2, k2, bc)

# Parameter values 3
f3, k3 = 0.035, 0.060
grid_u3, grid_v3, c_u3, c_v3 = gray_scott(width, dx, dt, t, Du, Dv, f3, k3, bc)
grid_u3_noise, grid_v3_noise, c_u3_noise, c_v3_noise = gray_scott_noise(width, dx, dt, t, Du, Dv, f3, k3, bc, seed=0)
all_concentrations_u3, all_concentrations_v3 = all_concentrations_noise(width, dx, dt, t, Du, Dv, f3, k3, bc)
